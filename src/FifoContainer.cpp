...
int FifoContainer::updateCurrentIdx()
{
...
*/
boolean FifoContainer::add(char * c, int size) // TODO remove containerIdx
{
	boolean ret = false;
...
byte * FifoContainer::currentContainerContent()
{
	if ( _currentIdx >= 0 ) {
...
int FifoContainer::currentContainerSize()
{
	if ( _currentIdx >= 0 ) {
...
void FifoContainer::freeCurrentContainer()
{
